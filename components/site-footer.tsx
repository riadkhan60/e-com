...
const WHATSAPP_NUMBER = '8801852998991';
const FACEBOOK_URL = 'https://www.facebook.com/Shilpiniclothing';
const TIKTOK_URL = 'https://tiktok.com/@shilpini';
const INSTAGRAM_URL = 'https://instagram.com/shilpini';
const EMAIL = 'info.shilpini@gmail.com';
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:justify-between sm:text-left">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              WhatsApp +880 1852-998991 · {EMAIL}
            </p>
          </div>
        </div>
